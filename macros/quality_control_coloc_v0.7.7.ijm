...
Dialog.addRadioButtonGroup("Save final concatenated arrays?", newArray("Yes", "No"), 1, 2, "No");
Dialog.show;
...
for (i = 0; i < pontos ; i++) {
	...
	if (File.exists(save_dir+fs+table_name_2+".csv") == true) {
		saveAs("Results", save_dir+fs+table_name_2+"_2.csv");
	} else if (File.exists(save_dir+fs+table_name_2+"_2.csv") == true) {
		saveAs("Results", save_dir+fs+table_name_2+"_3.csv");
	} else {
		saveAs("Results", save_dir+fs+table_name_2+".csv");
	};
...
//get x values
x_array_1 = newArray();
x_array_1_name = chan1+"_vs_"+chan2+"_x_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+x_array_1_name+".csv");
	run("Close");
};
...
//get y values
y_array_1 = newArray();
y_array_1_name = chan1+"_vs_"+chan2+"_y_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+y_array_1_name+".csv");
	run("Close");
};
...
//get z values
z_array_1 = newArray();
z_array_1_name = chan1+"_vs_"+chan2+"_z_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+z_array_1_name+".csv");
	run("Close");
};
...
//get x values
x_array_2 = newArray();
x_array_2_name = chan1+"_vs_"+chan3+"_x_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+x_array_2_name+".csv");
	run("Close");
};
...
//get y values
y_array_2 = newArray();
y_array_2_name = chan1+"_vs_"+chan3+"_y_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+y_array_2_name+".csv");
	run("Close");
};
...
//get z values
z_array_2 = newArray();
z_array_2_name = chan1+"_vs_"+chan3+"_z_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+z_array_2_name+".csv");
	run("Close");
};
...
if (chan4 != "None") {
	...
	//get x values
	x_array_3 = newArray();
	x_array_3_name = chan1+"_vs_"+chan4+"_x_values";
	for (i=0;i<list.length;i++) {
		file = File.openAsString(save_dir+fs+list[i]);
...
//get x values
x_array_4 = newArray();
x_array_4_name = chan2+"_vs_"+chan3+"_x_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+x_array_4_name+".csv");
	run("Close");
};
...
//get y values
y_array_4 = newArray();
y_array_4_name = chan2+"_vs_"+chan3+"_y_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+y_array_4_name+".csv");
	run("Close");
};
...
//get z values
z_array_4 = newArray();
z_array_4_name = chan2+"_vs_"+chan3+"_z_values";
for (i=0;i<list.length;i++) {
	file = File.openAsString(save_dir+fs+list[i]);
...
if (show_array == "Yes") {
	...
	saveAs("Results", save_dir+fs+z_array_4_name+".csv");
	run("Close");
};
...
if (chan4 != "None") {
	...
	//get x values
	x_array_5 = newArray();
	x_array_5_name = chan2+"_vs_"+chan4+"_x_values";
	for (i=0;i<list.length;i++) {
		file = File.openAsString(save_dir+fs+list[i]);
...
if (chan4 != "None") {
	...
	//get x values
	x_array_7 = newArray();
	x_array_7_name = chan3+"_vs_"+chan4+"_x_values";
	for (i=0;i<list.length;i++) {
		file = File.openAsString(save_dir+fs+list[i]);
